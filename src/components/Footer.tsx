            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li className="flex items-center text-muted-foreground"><Mail className="w-5 h-5 mr-3 text-primary" /> {t('company.contact.email')}</li>
                            <li className="flex items-center text-muted-foreground"><Building className="w-5 h-5 mr-3 text-primary" /> {t('company.name')}</li>
                            <li className="flex items-start text-muted-foreground"><MapPinIcon className="w-5 h-5 mr-3 text-primary mt-1 flex-shrink-0" /> {t('company.address_lines.0')}<br />{t('company.address_lines.1')}</li>
                        </ul>
                    </div>
                    <div>
