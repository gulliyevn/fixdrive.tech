        ...
        <section id="author" className="py-20 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        <div>
                            <h3 className="font-display text-3xl font-bold text-amber-900 mb-2">
                                Dr. Ayşe Kaya
                            </h3>
                        ...
                        <div className="space-y-4 text-amber-800 leading-relaxed">
                            <p>
                                20 yılı aşkın deneyimi ile binlerce insanın hayatına dokunmuş,
                                onların potansiyellerini keşfetmelerine yardımcı olmuş bir uzman.
                                Harvard Üniversitesi'nde Psikoloji doktorası yapmış ve dünya çapında
                                tanınan bir araştırmacı.
                            </p>
                            <p>
                                Kitapları 40'tan fazla ülkede yayınlanmış ve milyonlarca okuyucuya
                                ulaşmıştır. TEDx konuşmaları 50 milyondan fazla izlenme almış ve
                                uluslararası platformlarda düzenli olarak konuşmacı olarak yer almaktadır.
                            </p>
                            <p>
                                "Başarının Sırları" kitabı, yılların deneyimi ve araştırmasının
                                bir ürünü olarak, okuyucularına pratik ve uygulanabilir stratejiler sunuyor.
                            </p>
                        </div>
