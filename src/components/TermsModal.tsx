...
type TermsModalProps = { isOpen: boolean; onClose: () => void };
        ...
        <div className="space-y-6">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              By accessing and using FixDrive services, you accept and agree to be bound by the
              terms and provision of this agreement. These Terms of Service govern your use of our
              personal driver subscription service.
            </p>
          </section>
          <section>
            <h3 className="text-xl font-semibold text-foreground mb-3">2. Service Description</h3>
            <p className="text-muted-foreground leading-relaxed">
              FixDrive provides subscription-based personal driver services, connecting users with
              trusted drivers on fixed schedules. Our service includes driver matching, scheduling,
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Subscription fees are billed monthly or annually as selected. All fees are
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              All drivers undergo background checks and maintain appropriate insurance. FixDrive
              maintains liability insurance for rides conducted through our platform. Users are
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              FixDrive's liability is limited to the amount paid for the service. We are not liable
