    ...
    async (e: React.FormEvent) => {
      ...
      if (email) {
        try {
          ...
          const endpoint =
            'https://script.google.com/macros/s/AKfycby6Uc2AV4sRBaZQzQpsq7L0uk2K-tVoD1uk_220P0jLZCAahWYQ2NnNyiX7UvnYF6zY/exec';
          ...
          toast({
            ...
            description: t('newsletter.success.description', {
              city: ipData.city || t('newsletter.success.your_location'),
            }),
          });
          setEmail('');
        } catch (error) {
          ...
          <div className="mt-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div className="text-left">
                    <div className="text-xs text-white/80">
                      {t('newsletter.app_store.subtitle')}
                    </div>
              ...
              <motion.button
                onClick={() =>
                  window.open(
                    'https://play.google.com/store/apps/details?id=com.fixdrive.app',
                    '_blank',
                  )
                }
                className="flex items-center justify-center bg-gradient-to-r from-primary to-deep-blue text-white px-6 py-3 rounded-xl hover:from-primary/90 hover:to-deep-blue/90 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 shadow-lg hover:shadow-xl"
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <div className="text-left">
                    <div className="text-xs text-white/80">
                      {t('newsletter.google_play.subtitle')}
                    </div>
