    ...
    return (
        <section id="newsletter" className="py-16 md:py-24 bg-secondary">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Get early access and pilot offers</h2>
                    <p className="text-lg text-muted-foreground mb-8">Be the first to know when we launch in your city. Join our mailing list for updates.</p>
                    ...
                    <p className="text-sm text-muted-foreground mt-4">We'll send occasional updates. No spam.</p>
                    
                    {/* App Download Buttons */}
                    <div className="mt-8">
                        <h3 className="text-lg font-semibold text-foreground mb-4">Download FixDrive App</h3>
                        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                aria-label="Download FixDrive from App Store"
                            >
                            ...
                            <motion.button
                                ...
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                aria-label="Download FixDrive from Google Play"
                            >
                                <div className="flex items-center space-x-3">
                                    <div className="w-8 h-8 bg-white/20 rounded-lg flex items-center justify-center">
                                        <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="currentColor">
