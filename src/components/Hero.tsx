            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="flex justify-start">
                    ...
                    >
                        ...
                        <div className="absolute -inset-y-6 -inset-x-24 left-0 bg-black/50 rounded-r-2xl -z-10" style={{left: 'calc(-50vw + 50%)'}}></div>
                        <motion.h1 
                        ...
                        >
                            <span className="block text-4xl md:text-5xl lg:text-6xl font-light mb-2">{t('hero.line1')}</span>
                            <span className="block bg-gradient-to-r from-primary via-blue-400 to-primary bg-clip-text text-transparent">{t('hero.line2')}</span>
                        </motion.h1>
